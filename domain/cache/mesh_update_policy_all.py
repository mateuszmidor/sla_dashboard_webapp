...
class MeshUpdatePolicyAllConnections:
    ...
    def __init__(self, repo: Repo, test_id: TestID, lookback_seconds, max_data_age_seconds: int) -> None:
        self._repo = repo
    ...
    def get_update(self, mesh: MeshResults) -> MeshResults:
        ...
        logger.debug("Lookback: %ds", min_lookback)
        return self._repo.get_mesh_test_results(self._test_id, [], [], min_lookback, True)
